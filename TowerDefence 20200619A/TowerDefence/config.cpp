...
Towers_Info::Towers_Info() {
    ...
    this->tower1->cooldown.push_back(500);
    this->tower1->bullet.push_back("bullet11");
//this->tower1->damage.push_back(10);
    this->tower1->info.push_back("Primary Mushroom  Upgrade: 25 Return: 20 Damage: 10 CD: 5s");
...
//this->tower1->damage.push_back(15);
    this->tower1->info.push_back("Premium Mushroom!  Return: 20 Damage: 15 CD: 5s");
    ...
    this->tower2->cooldown.push_back(1500);
    this->tower2->bullet.push_back("bullet21");
//this->tower2->damage.push_back(75);
    this->tower2->info.push_back("Sunflower Return: 80 Damage: 75 CD: 15s");
...
//this->tower3->damage.push_back(25);
    this->tower3->info.push_back("Primary PeaShooter  Upgrade: 25 Return: 40 Damage: 25 CD: 5s");
...
//this->tower3->damage.push_back(50);
    this->tower3->info.push_back("Medium PeaShooter  Upgrade：40 Return: 50 Damage: 50 CD: 5s");
    this->tower3->imageurl.push_back(":/image/tower32.png");
    this->tower3->upgradecost.push_back(40);
    this->tower3->demolitionfeedback.push_back(75);
    this->tower3->cooldown.push_back(1000);
    this->tower3->bullet.push_back("bullet33");
//this->tower3->damage.push_back(75);
    this->tower3->info.push_back("Premium PeaShooter!  Return: 75 Damage: 75 CD: 10s");
...
Bullets_Info::Bullets_Info() {
    ...
    this->bullet11->speed = 10;
    this->bullet11->damage = 10;
    this->bullet11->duration = 100;
    this->bullet11->imageurl = ":/bullet11.gif";
    ...
    this->bullet12->duration = 100;
    this->bullet12->imageurl = ":/bullet12.gif";
    ...
    this->bullet31->speed = 10;
    this->bullet31->damage = 25;
    this->bullet31->duration = 100;
    this->bullet31->imageurl = ":/bullet31.gif";
    ...
    this->bullet32->duration = 100;
    this->bullet32->imageurl = ":/bullet32.gif";
    ...
    this->bullet33->duration = 100;
    this->bullet33->imageurl = ":/bullet33.gif";
