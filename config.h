...
public:
    ...
    int debug_width, debug_height, debug_x, debug_y;
};
...
public:
    ...
    int back_width, back_height, back_x, back_y;
    int lock_width, lock_height, lock_x, lock_y;
};
...
public:
    ...
    int progressbar_width, progressbar_height, progressbar_x, progressbar_y;
...
class HitEffect_Data {
public:
    string hiteffectname, imageurl;
    int duration;
};

class HitEffect_Info {
public:
    HitEffect_Info();
    HitEffect_Data *hiteffect11, *hiteffect12, *hiteffect21, *hiteffect31, *hiteffect32, *hiteffect33;
