...
void BulletManager::addBullet(string bulletname, int towerid, AcidPoint targetAP) {
    ...
    if (bulletname=="bullet31"||bulletname=="bullet32"||bulletname=="bullet33") this->core->audiomanager->playTower3();
    if (bulletname=="bullet32") {
